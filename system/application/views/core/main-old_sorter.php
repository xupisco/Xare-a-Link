...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
        ...
        <div style="float: right">ordenar:
            ...
            <a href="<?= $base; ?>/page:<?= $page; ?>/sort:users:<?= $sort_2; ?>" class="lsorter<?= ($sort_1 == "users") ? "_sel" : ""; ?>" rel="nofollow">usuários</a> |
        ...
        <tr style="background-color: #f6f6f6; font-size: 11px"><td>Nome</td><td align="center">Visitas</td><td align="center">Usuários</td><td align="right">Data</td></tr>
        <?php
		...
		<div style="float: right">ordenar:
            ...
            <a href="<?= $base; ?>/page:<?= $page; ?>/sort:<?= $sort_1; ?>:score" class="lsorter<?= ($sort_2 == "score") ? "_sel" : ""; ?>" rel="nofollow">avaliação</a> |
            ...
            <a href="<?= $base; ?>/page:<?= $page; ?>/sort:<?= $sort_1; ?>:users" class="lsorter<?= ($sort_2 == "users") ? "_sel" : ""; ?>" rel="nofollow">usuários</a> |
        ...
        <div id="content_rel">
        <table width="100%" cellpadding="3">
        <tr style="background-color: #f6f6f6; font-size: 11px"><td>Nome</td><td align="center">PageRank</td><td align="center">Avaliação</td><td align="center">Cliques</td><td align="center">Visitas</td><td align="center">Usuários</td><td align="right">Data</td></tr>
		<?php
		foreach($links->result() as $row) {
            ...
            echo "<td class='link_info' title='Visitas'>".$row->views."</td>";
            echo "<td class='link_info' title='Comentários'>".$row->users."</td>";
            echo "<td class='link_info' title='Data do cadastro' style='text-align: right' nowrap>".date("d/m/Y", $row->date_added)."</td>";
            echo "</tr>";
		}
		?>
