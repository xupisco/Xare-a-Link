...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
        ...
        <div id="dbar">
        <b>Sub-categorias</b> em <?= $content->name; ?></div>

        <div id="content_rel">
        <table width="100%" cellpadding="3">
        <tr style="background-color: #f6f6f6; font-size: 11px">
		    <td><a href="<?= $base; ?>/page:<?= $page; ?>/sort:name:<?= $sort_2; ?>" class="lsorter<?= ($sort_1 == "name") ? "_sel" : ""; ?>" rel="nofollow">Nome</a></td>
			<td align="center"><a href="<?= $base; ?>/page:<?= $page; ?>/sort:views:<?= $sort_2; ?>" class="lsorter<?= ($sort_1 == "views") ? "_sel" : ""; ?>" rel="nofollow">Visitas</a></td>
			<td align="center"><a href="<?= $base; ?>/page:<?= $page; ?>/sort:users:<?= $sort_2; ?>" class="lsorter<?= ($sort_1 == "users") ? "_sel" : ""; ?>" rel="nofollow">Usuários</a></td>
			<td align="right"><a href="<?= $base; ?>/page:<?= $page; ?>/sort:date:<?= $sort_2; ?>" class="lsorter<?= ($sort_1 == "date") ? "_sel" : ""; ?>" rel="nofollow">Data</a></td>
		</tr>
        <?php
