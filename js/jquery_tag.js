/*
  ...
  @version: 1.3
  @changes: fixed bug in case senstivity, fixed bug in delete selection and added filter to not show matches already taken
*/
                ...
                if (currentTag.tag) {
                    ...
                    if (settings.url) {
                        ...
                        for (i = 0; i < userTags.length; i++) {
                            if (userTags[i].indexOf(currentTag.tag) === 0 && !chosenTags[userTags[i]]) {
